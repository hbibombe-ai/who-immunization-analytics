...
if module == "Vue nationale":
    ...
    fig = px.scatter_mapbox(geo, lat="latitude", lon="longitude", size="zero_dose", color="niveau", hover_name="district", hover_data={"priority_score":":.1f", "cov_penta3":":.1%", "dropout":":.1%", "zero_rate":":.1%"}, color_discrete_map={"Faible":"#15803d", "Modéré":"#eab308", "Élevé":"#f97316", "Critique":"#dc2626"}, zoom=4.2, height=570, title="Carte décisionnelle des districts prioritaires")
    fig.update_layout(mapbox_style="open-street-map", margin=dict(l=10,r=10,t=55,b=10))
